...
class Cube:
    ...
    def rotate(self, directions):
        ...
        #use the below elif
            ...
            for i in list(self.cube):
                if not((47<ord(i)<58) or (64<ord(i)<91) or (96<ord(i)<123)):
                    result['status'] = 'error: '
                    return result
        
        for character in set(list(self.cube)):
            for element in list(self.cube):
        ...
        for character in list(self.cube):
            facesOfCube = [list(self.cube)[4],list(self.cube)[13],list(self.cube)[22],list(self.cube)[31],list(self.cube)[40],list(self.cube)[49]]
